...
class Potager(Zone):
    ...
    def _ajouteZone(self, zone):
        ...
        airePotager = self.longueur * self.largeur
        if airePotager < zone.getAire():
            raise Exception("zone trop grande !")
...
if __name__ == '__main__':
    ...
    maPremiereZoneFruit1 = ZoneFruits(50, 49)
    primeur.ajouteZone(maPremiereZoneFruit1)

    maPremiereZoneLegume1 = ZoneLegumes(20, 20)
